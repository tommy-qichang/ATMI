...
VALUES ("qi chang", "tommy.qichang@gmail.com", "(*EFDBUF", "", 0),
       ("hua fu", "fuhua@gmail.com", "(*EFBUF", "", 1),
       ("MJ", "mj@gmail.com", "(*EFsdfBUF", "", 0);


INSERT INTO instances(name, modality, description, data_path, has_audit, study_num, annotated_num)
VALUES ("CCTA", "CT", "Cardial CT Scan", "./data/CCTA", 0, 3, 0),
       ("Cardial_MRI_DB", "MRI", "Cardial MRI images", "./data/MRI", 0, 9, 0);
...
VALUES (1, 0, NULL, "Aorta"),
       (1, 0, NULL, "Left Ventricle"),
       (1, 0, NULL, "Right Ventricle"),
       (1, 0, NULL, "Left Atrium"),
       (1, 0, NULL, "Right Atrium"),
       (1, 0, NULL, "Stent"),
       (1, 1, "selectbox", '{"key":"Sex","value":["male","female"]}'),
       (1, 1, "input",'{"key":"Age","value":"Comments"}'),
       (1, 1, "input",'{"key":"Type","value":"type_default"}'),
       (2, 0, NULL, "Aorta2"),
       (2, 0, NULL, "Left Ventricle2"),
       (2, 0, NULL, "Right Ventricle2"),
       (2, 0, NULL, "Left Atrium2"),
       (2, 0, NULL, "Right Atrium2"),
       (2, 0, NULL, "Stent2"),
       (2, 1, "selectbox", '{"key":"Sex","value":["male","female"]}'),
       (2, 1, "selectbox", '{"key":"Type","value":["type1","type2","type3"]}'),
       (2, 1, "input",'{"key":"Age","value":"Comments"}'),
       (2, 1, "input",'{"key":"Type","value":""}');

INSERT INTO studies(instance_id, folder_name, total_files_number, annotators, auditors, status)
VALUES (1, "./data/CCTA/CRE_120-1014-CCTA-10-139967", 50, NULL, NULL, 1),
       (1, "./data/CCTA/DICOM", 90, NULL, NULL, 1),
       (1, "./data/CCTA/Dicom_691_2", 25, NULL, NULL, 1),
       (2, "./data/MRI/3CH_tagging", 25, NULL, NULL, 1),
       (2, "./data/MRI/3CH_tagging_30", 25, NULL, NULL, 1),
       (2, "./data/MRI/SAX_tagging_apex", 25, NULL, NULL, 1),
       (2, "./data/MRI/SAX_tagging_base", 25, NULL, NULL, 1);
