...
def setup_route_map(app, app_path):
    ...
    def export_all_label(instance_id):
        ...
        split_entry_num: entry numbers for each hdf5 file. Will create separate files end with id.
        ...
        msg = export_service.save_studies(instance_id, split_entry_num, store_type, save_label, save_data, compression)
